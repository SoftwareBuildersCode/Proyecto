...
if ($id == '' || $token == '') {
    ...
    if ($token == $token_tmp) {
        ...
        $sqlCaracter = $con->prepare("SELECT DISTINCT(det.id_carateristicas) AS idCat, caract.caracteristica FROM det_productos_caracteristicas AS det INNER JOIN caracteristicas AS caract ON det.
        id_carateristicas=caract.id
    ...
    <div class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarHeader">
                ...
                Carrito <span id="num_cart" class="badge bg-success"><?php echo $num_cart; ?></span>
                </a>
                ...
                <div class="col-3 my-3">
                    <?php 
                        while($row_cat = $sqlCaracter->fetch(PDO::FETCH_ASSOC)){
                            ...
                            while($row_cat = $sqlDet->fetch(PDO::FETCH_ASSOC)){
